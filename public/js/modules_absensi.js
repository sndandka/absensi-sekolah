...
function renderRS() {
  const tbody = rsIsSiswa ? document.querySelector('#pg-rekap #rekSiswaTbodySekolah') : document.querySelector('#pg-rekap_sekolah #rekTbodySekolah');
  if (!tbody) return;
...
function renderRM() {
  const tbody = rmIsSiswa ? document.querySelector('#pg-rekap #rekSiswaTbodyMapel') : document.querySelector('#pg-rekap_mapel #rekTbodyMapel');
  if (!tbody) return;
...
async function loadRekapSekolah() {
  ...
  const tbody = isSiswa ? document.querySelector('#pg-rekap #rekSiswaTbodySekolah') : document.querySelector('#pg-rekap_sekolah #rekTbodySekolah');
...
async function loadRekapMapel() {
  ...
  const dkStart = dtStart.replace(/-/g, '_');
  const dkEnd = dtEnd.replace(/-/g, '_');
  const tbody = isSiswa ? document.querySelector('#pg-rekap #rekSiswaTbodyMapel') : document.querySelector('#pg-rekap_mapel #rekTbodyMapel');
...
async function loadRekap() {
  ...
  const tbodySekolah = id('rekSiswaTbodySekolah');
  const tbodyMapel = id('rekSiswaTbodyMapel');
